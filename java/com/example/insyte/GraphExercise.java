...
public class GraphExercise extends AppCompatActivity implements OnChartGestureListener, OnChartValueSelectedListener {

    private static final String TAG = "GraphExercise";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseChart = (LineChart) findViewById(R.id.exerciseChart);
        ...
        exerciseChart.setOnChartGestureListener(GraphExercise.this);
        exerciseChart.setOnChartValueSelectedListener(GraphExercise.this);

        exerciseChart.setDragEnabled(true);
        ...
        for(int i = 0; i < userAnswers.size(); i++){
            ...
            yScores[i] = Float.valueOf(userAnswers.get(i).getA4());
        }
        ...
        LineDataSet set1 = new LineDataSet(yValues, "Minutes of Exercise");
        ...
        exerciseChart.getLowestVisibleX();
        exerciseChart.setBorderColor(R.color.blue_2);
        exerciseChart.setBorderWidth(2f);
        ...
        xAxis.setValueFormatter(new GraphExercise.XAxisValues(xValues));
        ...
        des.setText("Amount of Exercise");
        des.setTextColor(R.color.blue_2);
        des.setTextSize(20);
        exerciseChart.setDescription(des);
    }

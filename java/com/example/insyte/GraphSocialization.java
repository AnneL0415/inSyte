...
public class GraphSocialization extends AppCompatActivity implements OnChartGestureListener, OnChartValueSelectedListener {

    private static final String TAG = "GraphSocialization";

    private LineChart socialChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_socialization);

        socialChart = (LineChart) findViewById(R.id.socialChart);
        ...
        socialChart.setOnChartGestureListener(GraphSocialization.this);
        socialChart.setOnChartValueSelectedListener(GraphSocialization.this);

        socialChart.setDragEnabled(true);
        socialChart.setScaleEnabled(false);
        ...
        for(int i = 0; i < userAnswers.size(); i++){
            ...
            yScores[i] = Float.valueOf(userAnswers.get(i).getA3());
        }
        ...
        LineDataSet set1 = new LineDataSet(yValues, "Level of Socialization");
        ...
        socialChart.getLowestVisibleX();
        socialChart.setBorderColor(R.color.blue_2);
        socialChart.setBorderWidth(2f);
        ...
        XAxis xAxis = socialChart.getXAxis();
        xAxis.setValueFormatter(new GraphSocialization.XAxisValues(xValues));
        xAxis.setPosition(XAxis.XAxisPosition.BOTTOM);

        YAxis yAxis = socialChart.getAxisLeft();
        ...
        des.setText("Socialization Levels");
        des.setTextColor(R.color.blue_2);
        des.setTextSize(20);
        socialChart.setDescription(des);
    }

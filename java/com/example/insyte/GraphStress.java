...
public class GraphStress extends AppCompatActivity implements OnChartGestureListener, OnChartValueSelectedListener {

    private static final String TAG = "GraphStress";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_stress);

        stressChart = (LineChart) findViewById(R.id.stressChart);
        ...
        stressChart.setOnChartGestureListener(GraphStress.this);
        stressChart.setOnChartValueSelectedListener(GraphStress.this);

        stressChart.setDragEnabled(true);
        stressChart.setScaleEnabled(false);
        ...
        for(int i = 0; i < userAnswers.size(); i++){
            ...
            yScores[i] = Float.valueOf(userAnswers.get(i).getA2());
        }
        ...
        LineDataSet set1 = new LineDataSet(yValues, "Level of Stress");
        ...
        stressChart.getLowestVisibleX();
        stressChart.setBorderColor(R.color.blue_2);
        stressChart.setBorderWidth(2f);
        ...
        xAxis.setValueFormatter(new GraphStress.XAxisValues(xValues));
        ...
        des.setText("Stress Levels");
        des.setTextColor(R.color.blue_2);
        des.setTextSize(20);
        stressChart.setDescription(des);
    }
